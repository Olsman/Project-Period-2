function [MEMBRANE_POTENTIAL, INTERNODE_LENGTH, TIME_VECTOR] = Model(par, loc, tim, filename, isVerbose)
...
Istim = zeros(tns, 2, T);
Istim(loc(1), 1, tim(1):tim(1)+DUR) = Is/nns;
Istim(loc(2), 1, tim(2):tim(2)+DUR) = Is/nns;
